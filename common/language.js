...
const language_dict = {
    ...
    custom_new_tab_alert: {
        ...
        ja: "\"https://\" または \"http://\" で始まる完全修飾URL（FQDN付きURL）。例: ",
    ...
    help_msg_browser_set_change: {
        ...
        ja: "💡 最初にこの拡張を開くと、ブラウザから「変更を保持する」というメッセージが表示されますので、変更に同意するをクリックしてください。",
    ...
    help_msg_browser_set_a_target: {
        ...
        ja: "💡 ページのすべての＜a＞リンクのtarget属性を修正して；JSクリック属性に対して無効です。",
